...
<section class="section">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Form Tambah Pemesanan</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.pemesanan.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label for="tanggal_selesai" class="form-label">Tanggal Selesai (Estimasi)</label>
                            <input type="date" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('catatan') is-invalid @enderror" 
                                      ...
                                      name="catatan" 
                                      rows="4"
                                      placeholder="Catatan tambahan, kebutuhan khusus, dll...">{{ old('catatan') }}</textarea>
                            @error('catatan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
