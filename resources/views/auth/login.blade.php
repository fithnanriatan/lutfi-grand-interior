...
<head>
    ...
    <title>Login - Lutfi Grand Interior</title>
                ...
                <div id="auth-left">
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="username" name="username" class="form-control form-control-xl @error('username') is-invalid @enderror" 
